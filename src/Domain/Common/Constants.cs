...
public static class Constants
{
    ...
    public const string UsersFolderPathHost = "images/users";

    public const string ActorsFolderPathLocal = "images\\staff\\actors";
    public const string ActorsFolderPathHost = "images/staff/actors";
